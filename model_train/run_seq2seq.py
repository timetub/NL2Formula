...
from utils.nl2formula import NL2formulaTrainer
...
def main() -> None:
    ...
    with PicardLauncher() if picard_args.launch_picard and training_args.local_rank <= 0 else nullcontext(None):
        ...
        elif data_args.dataset in ["nl2vis"]:
           trainer = NL2formulaTrainer(**trainer_kwargs)
        else:
        ...
        if training_args.do_predict:
            ...
            results = trainer.predict(
                    dataset_splits.test_split.dataset,
                    dataset_splits.test_split.examples,
                    max_length=data_training_args.val_max_target_length,
                    max_time=data_training_args.val_max_time,
                    num_beams=data_training_args.num_beams,
            ...
            metrics["test_samples"] = len(dataset_splits.test_split.dataset)
